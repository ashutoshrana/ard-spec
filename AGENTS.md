...
| Demo probes an unrelated registry when its port is occupied | Background server startup failure was hidden before probing a fixed port | Require the launched process to remain alive before probes and test an occupied port |
